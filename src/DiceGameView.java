...
public class DiceGameView {
    ...
    private Icon diceGif = new ImageIcon("diceRoll.gif");
    ...
    DiceGameView(){
        ...
        diceGame.add(images,BorderLayout.WEST);

        images.add(statusArea,BorderLayout.WEST);
        statusArea.add(diceOutcome,FlowLayout.LEFT);
